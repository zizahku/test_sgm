...
WebUI.click(findTestObject('Produk page/img_bunda'))

WebUI.delay(2)

WebUI.click(findTestObject('Produk page/button_Rasa Stroberi'))

WebUI.delay(2)

WebUI.click(findTestObject('Produk page/button_Rasa Coklat'))

WebUI.delay(2)

WebUI.click(findTestObject('Produk page/button_300 gr'))
...
WebUI.click(findTestObject('Produk page/highlight_SOYA'))
