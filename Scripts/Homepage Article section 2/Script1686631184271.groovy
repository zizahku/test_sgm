...
WebUI.click(findTestObject('Homepage/img_article resep 1'))
...
WebUI.click(findTestObject('Homepage/img_article resep 2'))
...
WebUI.click(findTestObject('Homepage/img_article resep 3'))
...
WebUI.click(findTestObject('Homepage/btn Lihat Selengkapnya resep'))
